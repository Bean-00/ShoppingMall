...
<form name="updatePurchase" method="post" action="/purchase/updatePurchase?tranNo=10009">
        ...
        <tr>
            ...
            <td width="200" class="ct_write01">
                ...
                <img src="../images/ct_icon_date.gif" width="15" height="15"
                     onclick="show_calendar('document.updatePurchase.divyDate', $('form[name=addPurchase] input[name=dlvyDate]').val())"/>
            </td>
        </tr>
        <tr>
            <td height="1" colspan="3" bgcolor="D6D6D6"></td>
