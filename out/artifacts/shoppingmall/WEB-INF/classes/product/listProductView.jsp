		...
		<form name="detailForm" action="/listProduct.do?menu=manage"
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr class="ct_list_pop">
					...
					<td align="left"><a
						href="/getProduct.do?prodNo=10000&menu=manage">vaio vgn FS70B</a></td>
				...
				<tr class="ct_list_pop">
					...
					<td align="left"><a
						href="/getProduct.do?prodNo=10001&menu=manage">자전거</a></td>
				...
				<tr class="ct_list_pop">
					...
					<td align="left"><a
						href="/getProduct.do?prodNo=10002&menu=manage">보르도</a></td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td align="center"><a
						href="/listProduct.do?page=1&menu=manage">1</a> <a
						href="/listProduct.do?page=2&menu=manage">2</a> <a
						href="/listProduct.do?page=3&menu=manage">3</a></td>
				</tr>
			</table>
			<!--  페이지 Navigator 끝 -->
